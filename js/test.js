/**
 * test.js
 * @author bitofsky@neowiz.com 2013.08.01
 * @encoding UTF-8
 */
...
(function($, window, document) {
  ...
  define([/*Require*/], function() {
    ...
    var getTestFunction = function(testData, testResult) {
      ...
      var args = [testData.name, testData.args[0], testData.args[1]],
          resultContents = {}, resultType;
      ...
      var error = function(e) {
        ...
        try {
          var tpl = tag_escape(AJST.getTemplate(testData.name) || ''),
              compiler = tpl ? tag_escape(AJST.getCompiler(testData.name) || '') : '';
        } catch (e) {
        }
